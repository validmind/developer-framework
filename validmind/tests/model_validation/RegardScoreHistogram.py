...
@dataclass
class RegardScoreHistogram(Metric):
    """
    **Purpose:**
    The `RegardScoreHistogram` metric offers a histogram-based visualization of regard scores across different text
    ...
    **Limitations:**
    The efficacy of `RegardScoreHistogram` hinges upon the precision of underlying tools like `evaluate.load("regard")`, which
    ...
    name = "regard_score_histogram"
    required_inputs = ["model"]
    metadata = {
        "task_types": ["text_classification", "text_summarization"],
        "tags": ["regard_score_histogram"],
    }

...
```{r, results='hide'}
processed_tabular_results <- process_result(tabular_suite_results)
```

```{r, echo=FALSE}
pretty_print_all_plotly(processed_tabular_results)
```

```{r, echo=FALSE, results='asis'}
pretty_print_all_images(processed_tabular_results)
```

```{r, echo=FALSE, results='asis'}
pretty_print_all_tables(processed_tabular_results)
```
...
```{r}
processed_validation_results <- process_result(model_validation_results)
```
